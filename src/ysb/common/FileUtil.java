    ...
    throws Exception
  {
    ...
    if (paramFile.length() > 0L) {
      try
      {
        ...
        while (((str = localBufferedReader.readLine()) != null) && (str.indexOf(paramString3) == -1)) {}
        localStringBuffer.append(str);
        localStringBuffer.append(paramString1);
        while ((str = localBufferedReader.readLine()) != null) {
...
/* Location:              D:\DataDictionaryTool_0.2.1beta with dependencies\DataDictionaryTool_0.2.1beta.jar!\ysb\common\FileUtil.class
