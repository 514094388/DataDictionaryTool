  ...
  public void putTextToTable(int paramInt1, int paramInt2, String[] paramArrayOfString, int paramInt3)
  {
    ...
    for (int k = 0; k < paramArrayOfString.length; k++)
    {
      ...
      if (str != null)
      {
        ...
        {
          write(arrayOfString[m]);
          if ((arrayOfString.length > 1) && (m != arrayOfString.length - 1)) {
            println();
          }
        }
      }
...
/* Location:              D:\DataDictionaryTool_0.2.1beta with dependencies\DataDictionaryTool_0.2.1beta.jar!\org\ccs\sandbox\sqltool\datamodel\MSWord.class
