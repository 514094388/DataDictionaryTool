...
public class BatchProcessor
{
    ...
    throws Exception
  {
    ...
    case 1: 
      NavicatFileReader localNavicatFileReader = new NavicatFileReader();
      String[] arrayOfString = FileUtil.getFileContent(new File(paramString1), C.LINE_S, paramString2, "DROP TABLE");
    ...
    throws Throwable
  {
    ...
    FileUtil.transfer(getClass().getResourceAsStream("dict2.doc"), new FileOutputStream(str));
...
/* Location:              D:\DataDictionaryTool_0.2.1beta with dependencies\DataDictionaryTool_0.2.1beta.jar!\org\ccs\sandbox\sqltool\controller\BatchProcessor.class
